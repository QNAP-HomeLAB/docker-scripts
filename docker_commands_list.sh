...
fnc_help() {
  ...
  echo -e "  ${blu}DOCKER_COMPOSE COMMANDS${DEF}"
  ...
  echo -e "  ${blu}DOCKER_SERVICE COMMANDS${DEF}"
  ...
  echo -e "  ${blu}DOCKER_SWARM COMMANDS${DEF}"
  ...
  echo -e "  ${blu}DOCKER_SYSTEM COMMANDS${DEF}"
...
fnc_create_aliases(){
  # docker alias list
    ...
    dwb(){ sh /share/docker/scripts/docker_stack_bounce.sh "$1"; }
    alias dsb="dwb";
    alias bounce="dwb -all";
