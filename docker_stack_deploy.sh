...
helpFunction(){
  ...
  echo -e "        -${cyn}listed${DEF}    │ Deploys the 'listed' array of stacks defined in '${YLW}${docker_vars}/${cyn}swarm_stacks.conf${DEF}'"
  echo -e "        -${cyn}default${DEF}   │ Deploys the 'default' array of stacks defined in '${YLW}${docker_vars}/${cyn}swarm_stacks.conf${DEF}'"
